...
To reach out, please see the email address for [@d33bs](https://github.com/d33bs) or other community leaders on their GitHub profile page (after logging in).
...
**Action(s)**: Use of inappropriate language or other behavior deemed unprofessional or unwelcome in the community.
...
**Action(s)**: A violation through a single incident or series of actions.
...
**Action(s)**: A serious violation of community standards, including sustained inappropriate behavior.
...
**Action(s)**: Demonstrating a pattern of violation of community standards, including sustained inappropriate behavior, harassment of an individual, or aggression toward or disparagement of classes of individuals.
